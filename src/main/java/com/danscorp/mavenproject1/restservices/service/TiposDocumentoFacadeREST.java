...
@jakarta.ws.rs.Path("tiposdocumento")
public class TiposDocumentoFacadeREST extends AbstractFacade<TiposDocumento> {

    @PersistenceContext(unitName = "com.danscorp_mavenproject1_war_1.0-SNAPSHOTPU2")
    private EntityManager em;

    public TiposDocumentoFacadeREST() {
    ...
    @jakarta.ws.rs.Consumes(jakarta.ws.rs.core.MediaType.APPLICATION_JSON)
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, TiposDocumento entity) {
        super.edit(entity);
    }
    ...
    public TiposDocumento find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces(jakarta.ws.rs.core.MediaType.APPLICATION_JSON)
    public List<TiposDocumento> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
